...
- **Catálogo de notícias tem exatamente 5 fontes**, com o GE sempre presente e
  não-bloqueável (RN-03, RN-19). Trocar a 5ª fonte é alteração de configuração
  (`config/fontes.json`), nunca mudança de código.
